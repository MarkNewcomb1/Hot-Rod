...
heard someone report "ringing sounds" after they removed their foam. So leave yours in!</p>
	      ...
	      <div class="answer">
	        <figure class="content100"><img src="img/hot-rod-head.jpg"><figcaption>Photo courtesy of Dough Stalter</figcaption></figure>
	        <div class="clear"></div>
...
those old tube sockets. Doug at Vintone has pulled this one off, and was gracious enough to
include a series of pictures detailing how it was done. (See Vintone's website, click the picture to
go there.) Above is a picture of the final product. If you really want one, by all means contact
Doug or do it yourself. Though it would be much simpler (and less expensive) to just use the
